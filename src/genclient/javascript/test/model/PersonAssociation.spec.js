...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TunnelbotOpenApi30.PersonAssociation();
  });
  ...
  describe('PersonAssociation', function() {
    it('should create an instance of PersonAssociation', function() {
      // uncomment below and update the code to test PersonAssociation
      //var instance = new TunnelbotOpenApi30.PersonAssociation();
      //expect(instance).to.be.a(TunnelbotOpenApi30.PersonAssociation);
    });
