...
export class FarmApi {
  ...
  addFarm(body, id, kind, name, createDate, address, owners, people, callback) {
    ...
    if (body === undefined || body === null) {
      throw new Error(
        "Missing the required parameter 'body' when calling addFarm",
      );
    }
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error(
        "Missing the required parameter 'id' when calling addFarm",
      );
    }
    // verify the required parameter 'kind' is set
    if (kind === undefined || kind === null) {
      throw new Error(
        "Missing the required parameter 'kind' when calling addFarm",
      );
    }
    // verify the required parameter 'name' is set
    if (name === undefined || name === null) {
      throw new Error(
        "Missing the required parameter 'name' when calling addFarm",
      );
    }
    // verify the required parameter 'createDate' is set
    if (createDate === undefined || createDate === null) {
      throw new Error(
        "Missing the required parameter 'createDate' when calling addFarm",
      );
    }
    // verify the required parameter 'address' is set
    if (address === undefined || address === null) {
      throw new Error(
        "Missing the required parameter 'address' when calling addFarm",
      );
    }
    // verify the required parameter 'owners' is set
    if (owners === undefined || owners === null) {
      throw new Error(
        "Missing the required parameter 'owners' when calling addFarm",
      );
    }
    // verify the required parameter 'people' is set
    if (people === undefined || people === null) {
      throw new Error(
        "Missing the required parameter 'people' when calling addFarm",
      );
    }
    ...
    let formParams = {
      ...
      address: address,
      owners: this.apiClient.buildCollectionParam(owners, "multi"),
      people: this.apiClient.buildCollectionParam(people, "multi"),
    };
  ...
  addPerson(body, farmId, callback) {
    ...
    if (farmId === undefined || farmId === null) {
      throw new Error(
        "Missing the required parameter 'farmId' when calling addPerson",
      );
    }
  ...
  deleteFarm(farmId, opts, callback) {
    ...
    if (farmId === undefined || farmId === null) {
      throw new Error(
        "Missing the required parameter 'farmId' when calling deleteFarm",
      );
    }
  ...
  getFarmById(farmId, callback) {
    ...
    if (farmId === undefined || farmId === null) {
      throw new Error(
        "Missing the required parameter 'farmId' when calling getFarmById",
      );
    }
  ...
  removePerson(
    ...
    if (body === undefined || body === null) {
      throw new Error(
        "Missing the required parameter 'body' when calling removePerson",
      );
    }
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error(
        "Missing the required parameter 'id' when calling removePerson",
      );
    }
    // verify the required parameter 'kind' is set
    if (kind === undefined || kind === null) {
      throw new Error(
        "Missing the required parameter 'kind' when calling removePerson",
      );
    }
    // verify the required parameter 'name' is set
    if (name === undefined || name === null) {
      throw new Error(
        "Missing the required parameter 'name' when calling removePerson",
      );
    }
    // verify the required parameter 'createDate' is set
    if (createDate === undefined || createDate === null) {
      throw new Error(
        "Missing the required parameter 'createDate' when calling removePerson",
      );
    }
    // verify the required parameter 'address' is set
    if (address === undefined || address === null) {
      throw new Error(
        "Missing the required parameter 'address' when calling removePerson",
      );
    }
    // verify the required parameter 'owners' is set
    if (owners === undefined || owners === null) {
      throw new Error(
        "Missing the required parameter 'owners' when calling removePerson",
      );
    }
    // verify the required parameter 'people' is set
    if (people === undefined || people === null) {
      throw new Error(
        "Missing the required parameter 'people' when calling removePerson",
      );
    }
    // verify the required parameter 'farmId' is set
    if (farmId === undefined || farmId === null) {
      throw new Error(
        "Missing the required parameter 'farmId' when calling removePerson",
      );
    }
  ...
  updateFarm(
    ...
    if (body === undefined || body === null) {
      throw new Error(
        "Missing the required parameter 'body' when calling updateFarm",
      );
    }
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error(
        "Missing the required parameter 'id' when calling updateFarm",
      );
    }
    // verify the required parameter 'kind' is set
    if (kind === undefined || kind === null) {
      throw new Error(
        "Missing the required parameter 'kind' when calling updateFarm",
      );
    }
    // verify the required parameter 'name' is set
    if (name === undefined || name === null) {
      throw new Error(
        "Missing the required parameter 'name' when calling updateFarm",
      );
    }
    // verify the required parameter 'createDate' is set
    if (createDate === undefined || createDate === null) {
      throw new Error(
        "Missing the required parameter 'createDate' when calling updateFarm",
      );
    }
    // verify the required parameter 'address' is set
    if (address === undefined || address === null) {
      throw new Error(
        "Missing the required parameter 'address' when calling updateFarm",
      );
    }
    // verify the required parameter 'owners' is set
    if (owners === undefined || owners === null) {
      throw new Error(
        "Missing the required parameter 'owners' when calling updateFarm",
      );
    }
    // verify the required parameter 'people' is set
    if (people === undefined || people === null) {
      throw new Error(
        "Missing the required parameter 'people' when calling updateFarm",
      );
    }
