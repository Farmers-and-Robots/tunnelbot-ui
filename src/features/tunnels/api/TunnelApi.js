...
export class TunnelApi {
  ...
  addTunnel(body, id, kind, name, callback) {
    ...
    if (body === undefined || body === null) {
      throw new Error(
        "Missing the required parameter 'body' when calling addTunnel",
      );
    }
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error(
        "Missing the required parameter 'id' when calling addTunnel",
      );
    }
    // verify the required parameter 'kind' is set
    if (kind === undefined || kind === null) {
      throw new Error(
        "Missing the required parameter 'kind' when calling addTunnel",
      );
    }
    // verify the required parameter 'name' is set
    if (name === undefined || name === null) {
      throw new Error(
        "Missing the required parameter 'name' when calling addTunnel",
      );
    }
  ...
  deleteTunnel(tunnelId, opts, callback) {
    ...
    if (tunnelId === undefined || tunnelId === null) {
      throw new Error(
        "Missing the required parameter 'tunnelId' when calling deleteTunnel",
      );
    }
  ...
  getTunnelById(tunnelId, callback) {
    ...
    if (tunnelId === undefined || tunnelId === null) {
      throw new Error(
        "Missing the required parameter 'tunnelId' when calling getTunnelById",
      );
    }
  ...
  updateTunnel(body, id, kind, name, callback) {
    ...
    if (body === undefined || body === null) {
      throw new Error(
        "Missing the required parameter 'body' when calling updateTunnel",
      );
    }
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error(
        "Missing the required parameter 'id' when calling updateTunnel",
      );
    }
    // verify the required parameter 'kind' is set
    if (kind === undefined || kind === null) {
      throw new Error(
        "Missing the required parameter 'kind' when calling updateTunnel",
      );
    }
    // verify the required parameter 'name' is set
    if (name === undefined || name === null) {
      throw new Error(
        "Missing the required parameter 'name' when calling updateTunnel",
      );
    }
